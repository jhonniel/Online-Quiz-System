...
class HiringApplicationReconsideration extends Mailable
{
    ...
    public function envelope(): Envelope
    {
        ...
        return new Envelope(
            subject: "Application Reconsidered - {$positionTitle}",
        );
    }
        ...
        if ($this->position && strcasecmp($this->position->employment_type ?? '', 'Internship') === 0) {
            ...
            if ($torPdfPath) {
                try {
                    ...
                    \Log::error('Failed to attach TOR PDF to reconsideration email', [
                        'error' => $e->getMessage(),
                        'tor_path' => $torPdfPath,
