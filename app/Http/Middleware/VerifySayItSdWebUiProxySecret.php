...
/**
 * Restricts Say-it SD Web UI reverse proxy to callers that know the shared secret.
 */
class VerifySayItSdWebUiProxySecret
{
    public function handle(Request $request, Closure $next): Response
    {
        if (SayItImageSettings::sdWebuiInternalBaseUrl() === '') {
            abort(404);
        }
