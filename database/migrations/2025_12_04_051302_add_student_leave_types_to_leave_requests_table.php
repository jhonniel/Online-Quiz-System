...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if ($driver === 'pgsql') {
            ...
            DB::statement("ALTER TABLE leave_requests ADD CONSTRAINT leave_requests_type_check CHECK (type IN ('vacation_leave', 'sick_leave', 'work_from_home', 'absent', 'overtime', 'offset', 'additional_time', 'other'))");
        } elseif ($driver === 'mysql') {
            // MySQL: Modify the ENUM column
            DB::statement("ALTER TABLE leave_requests MODIFY COLUMN type ENUM('vacation_leave', 'sick_leave', 'work_from_home', 'absent', 'overtime', 'offset', 'additional_time', 'other') DEFAULT 'vacation_leave'");
        } else {
