{{-- Permission-gated admin sections (sub-features) --}}
        <!-- Content Management -->
        ...
        <div class="mb-6" x-data="{
            ...
            <div class="space-y-1" x-show="sidebarCollapsed ? true : open" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
                ...
                @endif
                @if(auth()->user()->canAccessContentFeature('announcements'))
                <a href="{{ route('admin.system-announcements.index') }}"
                   class="flex items-center px-3 py-2 text-sm font-medium rounded-md transition-colors duration-200 {{ request()->routeIs('admin.system-announcements.*') ? 'bg-indigo-700 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}"
                   :class="sidebarCollapsed ? 'justify-center' : ''"
                   :title="sidebarCollapsed ? 'Announcement' : ''">
                    <svg class="h-5 w-5 flex-shrink-0" :class="sidebarCollapsed ? '' : 'mr-3'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="mb-6 user-features-section" x-data="{
            ...
            <div class="space-y-1" x-show="sidebarCollapsed ? true : open" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
                ...
                <a href="{{ route('admin.confession.chat-rooms') }}"
                   class="flex items-center px-3 py-2 text-sm font-medium rounded-md transition-colors duration-200 {{ request()->is('admin/confession/chat-rooms*') ? 'bg-indigo-700 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}"
                   :class="sidebarCollapsed ? 'justify-center' : ''"
                   :title="sidebarCollapsed ? 'Chat rooms' : ''">
                    <svg class="h-5 w-5 flex-shrink-0" :class="sidebarCollapsed ? '' : 'mr-3'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8h2a2 2 0 012 2v6a2 2 0 01-2 2h-2v4l-4-4H9a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2"></path>
                    </svg>
                    <span class="transition-opacity duration-300" :class="sidebarCollapsed ? 'opacity-0 w-0 overflow-hidden' : 'opacity-100'">Chat rooms</span>
                </a>
            </div>
        </div>
        @endif
        ...
        <div class="mb-6" x-data="{
            ...
            <div class="space-y-1" x-show="sidebarCollapsed ? true : open" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
                ...
                <a href="{{ route('admin.anonymous-chats.index') }}"
                   ...
                   :class="sidebarCollapsed ? 'justify-center' : ''"
                   :title="sidebarCollapsed ? 'Anonymous Chats' : ''">
                    <svg class="h-5 w-5 flex-shrink-0" :class="sidebarCollapsed ? '' : 'mr-3'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="mb-6" x-data="{
            open: (localStorage.getItem('nav-employee-documents') || 'true') === 'true',
            toggle() {
                this.open = !this.open;
                localStorage.setItem('nav-employee-documents', this.open);
            }
        }">
            <button @click="toggle()"
                    class="w-full flex items-center justify-between px-3 py-2 text-xs font-semibold text-gray-400 uppercase tracking-wider hover:text-gray-300 transition-opacity duration-300"
            ...
            <div class="space-y-1" x-show="sidebarCollapsed ? true : open" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
                @if(auth()->user()->canAccessEmployeeFeature('file_request'))
                <a href="{{ url('/admin/file-request') }}"
                   class="flex items-center px-3 py-2 text-sm font-medium rounded-md transition-colors duration-200 {{ request()->routeIs('admin.file-request.*') ? 'bg-indigo-700 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}"
                   :class="sidebarCollapsed ? 'justify-center' : ''"
                   :title="sidebarCollapsed ? 'File Request' : ''">
                    <svg class="h-5 w-5 flex-shrink-0" :class="sidebarCollapsed ? '' : 'mr-3'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                    </svg>
                    <span class="transition-opacity duration-300" :class="sidebarCollapsed ? 'opacity-0 w-0 overflow-hidden' : 'opacity-100'">File Request</span>
                </a>
                @endif
                @if(auth()->user()->canAccessEmployeeFeature('payslip'))
                <a href="{{ url('/admin/payslip') }}"
                   class="flex items-center px-3 py-2 text-sm font-medium rounded-md transition-colors duration-200 {{ request()->routeIs('admin.payslip.*') ? 'bg-indigo-700 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}"
                   :class="sidebarCollapsed ? 'justify-center' : ''"
                   :title="sidebarCollapsed ? 'Payslip' : ''">
                    <svg class="h-5 w-5 flex-shrink-0" :class="sidebarCollapsed ? '' : 'mr-3'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span class="transition-opacity duration-300" :class="sidebarCollapsed ? 'opacity-0 w-0 overflow-hidden' : 'opacity-100'">Payslip</span>
                </a>
                @endif
                @if(auth()->user()->canAccessEmployeeFeature('employee_nda'))
                <a href="{{ url('/admin/employee-documents/nda') }}"
                   class="flex items-center px-3 py-2 text-sm font-medium rounded-md transition-colors duration-200 {{ request()->routeIs('admin.employee-documents.nda') ? 'bg-indigo-700 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}"
                   :class="sidebarCollapsed ? 'justify-center' : ''"
                ...
                @endif
                @if(auth()->user()->canAccessEmployeeFeature('employee_contract'))
                <a href="{{ url('/admin/employee-documents/contract') }}"
                   class="flex items-center px-3 py-2 text-sm font-medium rounded-md transition-colors duration-200 {{ request()->routeIs('admin.employee-documents.contract') ? 'bg-indigo-700 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}"
                   :class="sidebarCollapsed ? 'justify-center' : ''"
                ...
                @endif
                @if(auth()->user()->canAccessEmployeeFeature('employee_policy'))
                <a href="{{ url('/admin/employee-documents/policy') }}"
                   class="flex items-center px-3 py-2 text-sm font-medium rounded-md transition-colors duration-200 {{ request()->routeIs('admin.employee-documents.policy') ? 'bg-indigo-700 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}"
                   :class="sidebarCollapsed ? 'justify-center' : ''"
                ...
                @endif
                @if(auth()->user()->canAccessEmployeeFeature('employee_handbook'))
                <a href="{{ url('/admin/employee-documents/handbook') }}"
                   class="flex items-center px-3 py-2 text-sm font-medium rounded-md transition-colors duration-200 {{ request()->routeIs('admin.employee-documents.handbook') ? 'bg-indigo-700 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}"
                   :class="sidebarCollapsed ? 'justify-center' : ''"
                ...
                <a href="{{ url('/admin/employee-documents/signatures') }}"
                   ...
                   :class="sidebarCollapsed ? 'justify-center' : ''"
                   :title="sidebarCollapsed ? 'Signatures' : ''">
                    <svg class="h-5 w-5 flex-shrink-0" :class="sidebarCollapsed ? '' : 'mr-3'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="mb-6" x-data="{
            ...
            toggle() {
                this.open = !this.open;
                localStorage.setItem('nav-teachers-management', this.open);
            }
        }"
        x-init="if ({{ request()->routeIs('admin.teachers-management.*') || request()->routeIs('admin.teacher-invites.*') || request()->routeIs('admin.teacher-moa.*') || request()->routeIs('admin.teacher-excused-requests.*') ? 'true' : 'false' }}) { open = true; }">
            <button @click="toggle()"
                    class="w-full flex items-center justify-between px-3 py-2 text-xs font-semibold text-gray-400 uppercase tracking-wider hover:text-gray-300 transition-opacity duration-300"
                    :class="sidebarCollapsed ? 'opacity-0 h-0 overflow-hidden pointer-events-none' : 'opacity-100'">
            ...
            <div class="space-y-1" x-show="sidebarCollapsed ? true : open" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
                ...
                <a href="{{ url('/admin/teachers-management/teachers') }}"
                   ...
                   :class="sidebarCollapsed ? 'justify-center' : ''"
                   :title="sidebarCollapsed ? 'Teachers' : ''">
                    <svg class="h-5 w-5 flex-shrink-0" :class="sidebarCollapsed ? '' : 'mr-3'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 14l9-5-9-5-9 5 9 5zm0 0v6m-6-3h12"></path>
                    </svg>
                    <span class="transition-opacity duration-300" :class="sidebarCollapsed ? 'opacity-0 w-0 overflow-hidden' : 'opacity-100'">
                        Teachers
                    </span>
                ...
                <a href="{{ url('/admin/teachers-management/invite-links') }}"
                   ...
                   :class="sidebarCollapsed ? 'justify-center' : ''"
                   :title="sidebarCollapsed ? 'Invite Links' : ''">
                    <svg class="h-5 w-5 flex-shrink-0" :class="sidebarCollapsed ? '' : 'mr-3'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.828 10.172a4 4 0 015.657 5.656l-3.536 3.536a4 4 0 01-5.657-5.656m-4.95-.707a4 4 0 00-5.657 5.657l3.536 3.535a4 4 0 005.657-5.656"></path>
                    </svg>
                    <span class="transition-opacity duration-300" :class="sidebarCollapsed ? 'opacity-0 w-0 overflow-hidden' : 'opacity-100'">
                        Invite Links
                    </span>
        ...
        <div class="mb-6" x-data="{
            ...
            <div class="space-y-1" x-show="sidebarCollapsed ? true : open" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
                ...
                @endif
                @if(auth()->user()->canAccessUserManagementFeature('user_maps'))
                <a href="{{ url('/admin/user-maps') }}"
                   class="flex items-center px-3 py-2 text-sm font-medium rounded-md transition-colors duration-200 {{ request()->routeIs('admin.user-maps.*') ? 'bg-indigo-700 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}"
                   :class="sidebarCollapsed ? 'justify-center' : ''"
                   :title="sidebarCollapsed ? 'User Maps' : ''">
                    <svg class="h-5 w-5 flex-shrink-0" :class="sidebarCollapsed ? '' : 'mr-3'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="mb-6" x-data="{
            ...
            <div class="space-y-1" x-show="sidebarCollapsed ? true : open" x-transition:enter="transition ease-out duration-100" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition ease-in duration-75" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0">
                ...
                @endif
                @if(auth()->user()->canAccessSystemFeature('travel_time'))
                <a href="{{ url('/admin/system/travel-time') }}"
                   class="flex items-center px-3 py-2 text-sm font-medium rounded-md transition-colors duration-200 {{ request()->routeIs('admin.system.travel-time.*') ? 'bg-indigo-700 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}"
                   :class="sidebarCollapsed ? 'justify-center' : ''"
                   :title="sidebarCollapsed ? 'Travel Time' : ''">
                    <svg class="h-5 w-5 flex-shrink-0" :class="sidebarCollapsed ? '' : 'mr-3'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ url('/admin/system/api-monitoring') }}"
                   ...
                   :class="sidebarCollapsed ? 'justify-center' : ''"
                   :title="sidebarCollapsed ? 'API Monitoring' : ''">
                    <svg class="h-5 w-5 flex-shrink-0" :class="sidebarCollapsed ? '' : 'mr-3'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 9h8M8 13h6m5-1a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
                    <span class="transition-opacity duration-300" :class="sidebarCollapsed ? 'opacity-0 w-0 overflow-hidden' : 'opacity-100'">
                        API Monitoring
                    </span>
                ...
                @endif
                @if(auth()->user()->canAccessSystemFeature('network_graph'))
                <a href="{{ url('/admin/system/network-graph') }}"
                   class="flex items-center px-3 py-2 text-sm font-medium rounded-md transition-colors duration-200 {{ request()->routeIs('admin.system.network-graph.*') ? 'bg-indigo-700 text-white' : 'text-gray-300 hover:bg-gray-700 hover:text-white' }}"
                   :class="sidebarCollapsed ? 'justify-center' : ''"
                   :title="sidebarCollapsed ? 'Network Graph' : ''">
                    <svg class="h-5 w-5 flex-shrink-0" :class="sidebarCollapsed ? '' : 'mr-3'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
