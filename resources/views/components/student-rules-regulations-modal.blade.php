...
>
    ...
    <div class="relative w-full max-w-2xl rounded-xl shadow-xl">
        <div class="flex max-h-[85vh] flex-col overflow-hidden rounded-xl border {{ $modalCard }}">
            ...
            <div class="flex-1 min-h-0 overflow-y-auto px-5 py-4 custom-scrollbar text-sm {{ $studentRulesFinalWarning ? 'text-red-950' : 'text-gray-700' }} space-y-4 leading-relaxed {{ $modalBody }}">
            ...
            <label class="flex items-start gap-3 cursor-pointer select-none">
                <input type="checkbox" x-model="agreed" class="mt-1 h-4 w-4 rounded border-gray-300 {{ $studentRulesFinalWarning ? 'text-red-700 focus:ring-red-500' : 'text-indigo-600 focus:ring-indigo-500' }}">
