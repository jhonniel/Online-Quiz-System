...
<div class="px-3 sm:px-4 lg:px-6 py-4 max-w-4xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="px-4 sm:px-6 py-5 border-b border-gray-200 bg-gray-50/50">
            ...
            <p class="text-sm text-gray-500 mt-0.5">Update the device and account information.</p>
        </div>
        <form action="{{ url('/admin/starlinks/'.$starlink->id) }}" method="POST" class="p-4 sm:p-6">
            @csrf
            @method('PUT')
