@php
    ...
    $inputClass = 'mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm';
    $selectClass = 'mt-1 block w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm';
@endphp

{{-- Account --}}
<div class="mb-8">
    <h3 class="text-sm font-semibold text-gray-900 uppercase tracking-wider mb-4">Account</h3>
...
{{-- Device --}}
<div class="mb-8">
    <h3 class="text-sm font-semibold text-gray-900 uppercase tracking-wider mb-4">Device</h3>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
        <div>
...
{{-- Network --}}
<div class="mb-8">
    <h3 class="text-sm font-semibold text-gray-900 uppercase tracking-wider mb-4">Network</h3>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
        <div>
...
{{-- Location & dates --}}
<div class="mb-8">
    <h3 class="text-sm font-semibold text-gray-900 uppercase tracking-wider mb-4">Location & dates</h3>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
        <div>
        ...
        <div>
            ...
            <input type="date" name="start_date" id="start_date" value="{{ old('start_date', $starlink && $starlink->start_date ? $starlink->start_date->format('Y-m-d') : '') }}" class="{{ $inputClass }}" />
...
{{-- Plan, status & contact --}}
<div class="mb-0">
    <h3 class="text-sm font-semibold text-gray-900 uppercase tracking-wider mb-4">Plan, status & contact</h3>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
        <div>
