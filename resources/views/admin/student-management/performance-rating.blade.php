...
<div class="space-y-6">
        ...
        <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div class="flex items-start min-w-0">
                ...
                <div class="ml-4 min-w-0">
                    ...
                    <p class="text-indigo-100 mt-1 truncate"><x-user-name :user="$student" class="inline text-indigo-100" /> · {{ optional($student->university)->name ?? 'No school' }}@if(filled($student->course)) · {{ $student->course }}@endif</p>
                </div>
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
        <div class="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
            ...
            <p class="mt-2 text-lg font-bold text-gray-900 leading-snug"><x-user-name :user="$student" /></p>
