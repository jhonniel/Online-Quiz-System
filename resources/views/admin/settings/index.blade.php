        ...
        <div class="border-b border-gray-200 bg-gray-50 px-6">
            ...
            <div class="p-8">
                ...
                <div class="space-y-8">
                    ...
                    <!-- RULES AND REGULATIONS — edited under System → Rules -->
                    <div class="form-section">
                        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                            <div class="flex items-start space-x-3">
                                ...
                                <div>
                                    <h3 class="text-lg font-semibold text-gray-900">RULES AND REGULATIONS (students)</h3>
                                    <p class="text-sm text-gray-500 mt-1 max-w-2xl">
                                        The agreement modal body under the fixed title is maintained on <strong class="text-gray-800">System → Rules</strong>. Leave empty there for the built‑in default text.
                                    </p>
                                </div>
                            </div>
                            <a href="{{ url('/admin/system/rules') }}"
                               class="inline-flex items-center justify-center px-5 py-2.5 rounded-xl bg-indigo-600 text-white text-sm font-semibold hover:bg-indigo-700 whitespace-nowrap shrink-0">
                                Open Rules editor
                            </a>
                        </div>
                    </div>
