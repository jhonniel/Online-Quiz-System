    ...
    <div class="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
        ...
        <div class="border-b border-gray-200 bg-gray-50 px-6">
            <nav class="flex space-x-1 -mb-px" aria-label="Tabs" style="position: relative; z-index: 100;">
                ...
                <button type="button" onclick="event.preventDefault(); event.stopPropagation(); if(window.showTab) window.showTab('hiring'); return false;" id="tab-hiring" class="settings-tab">
                    <div class="flex items-center space-x-2">
                        <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
