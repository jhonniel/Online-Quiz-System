...
<x-responsive-admin-table
    ...
    :add-button-route="route('universities.create')"
>
    <x-responsive-table
        :headers="[
                ...
                <td class="px-3 sm:px-4 lg:px-6 py-3 whitespace-nowrap text-right text-sm font-medium">
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open"
                            ...
                            <a href="{{ route('universities.show', $university) }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 flex items-center">
                            ...
                            <a href="{{ route('universities.edit', $university) }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 flex items-center">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            @if($university->users_count == 0)
                                ...
                                <form method="POST" action="{{ route('universities.destroy', $university) }}" class="block" onsubmit="return confirmUniversityAction('delete', this)">
                                    @csrf
                                    @method('DELETE')
