...
<x-responsive-admin-table
    ...
    :add-button-route="url('/admin/universities/create')"
>
    <x-responsive-table
        :headers="[
                ...
                <td class="px-3 sm:px-4 lg:px-6 py-3 whitespace-nowrap text-right text-sm font-medium">
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open"
                            ...
                            <a href="{{ url('/admin/universities/' . $university->id) }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 flex items-center">
                            ...
                            <a href="{{ url('/admin/universities/' . $university->id . '/edit') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 flex items-center">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <form method="POST" action="{{ url('/admin/universities/' . $university->id . '/toggle-status') }}" class="block">
                                @csrf
                                @method('PATCH')
                            ...
                            @if($university->users_count == 0)
                                ...
                                <form method="POST" action="{{ url('/admin/universities/' . $university->id) }}" class="block" onsubmit="return confirmUniversityAction('delete', this)">
                                    @csrf
                                    @method('DELETE')
