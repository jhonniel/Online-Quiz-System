    ...
    <div class="bg-gradient-to-br from-indigo-600 via-indigo-700 to-purple-700 rounded-2xl shadow-xl px-4 py-6 sm:px-6 sm:py-8 text-white">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    <h1 class="text-2xl sm:text-3xl font-bold">Daily Time Record (DTR)</h1>
                    <p class="text-sm sm:text-base text-indigo-100 mt-1">View and manage all employee time records</p>
                </div>
            </div>
    ...
    <div class="bg-white rounded-2xl shadow-xl border border-gray-200 p-4 sm:p-6">
        <form method="GET" action="{{ route('admin.dtr.index') }}" class="space-y-4">
            ...
            <div class="flex flex-wrap items-center gap-3">
                ...
                <a href="{{ route('admin.dtr.index') }}" class="inline-flex items-center px-4 sm:px-6 py-2 border border-gray-300 text-xs sm:text-sm font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                    Reset
                </a>
            </div>
        </form>
