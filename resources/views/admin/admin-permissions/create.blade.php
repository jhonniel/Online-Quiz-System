...
@section('page-title', 'Add Employee to Permissions')
...
@section('breadcrumb')
    ...
    <li>
        <div class="flex items-center">
            ...
            <span class="ml-2 text-sm font-medium text-gray-500">Add Employee</span>
        </div>
    </li>
@endsection
...
<div class="h-full flex flex-col space-y-3">
    ...
    <div class="bg-gradient-to-r from-indigo-500 to-indigo-600 rounded-lg shadow-sm p-4 flex-shrink-0 mx-2 sm:mx-3 lg:mx-4 xl:mx-6">
        <div class="flex items-center justify-between">
            <div>
                <h2 class="text-xl sm:text-2xl font-bold text-white">Add Employee to Permissions</h2>
                <p class="mt-1 text-sm text-indigo-100">Select a specific employee to assign feature access permissions</p>
            </div>
    ...
    <div class="flex-1 bg-white rounded-lg shadow-sm border border-gray-200 mx-2 sm:mx-3 lg:mx-4 xl:mx-6 p-4 sm:p-6">
        @if($employees->isEmpty())
            <div class="text-center py-12">
                ...
                <p class="mt-1 text-sm text-gray-500">All employees already have permissions assigned.</p>
                <div class="mt-6">
                    <a href="{{ route('admin.admin-permissions.index') }}"
        ...
        @else
            <form action="{{ route('admin.admin-permissions.store') }}" method="POST">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <p class="text-sm text-gray-500 mb-4">Choose a specific employee to add to the permissions management system. You can configure their feature access after adding them.</p>
