...
<div class="max-w-2xl mx-auto">
    <div class="bg-white shadow rounded-lg">
        <div class="px-4 py-5 sm:p-6">
            <div class="mb-6">
                <h2 class="text-2xl font-bold text-gray-900">Add New Stack</h2>
                <p class="mt-1 text-sm text-gray-600">Add a new technology stack to display on the landing page.</p>
            </div>

            <form action="{{ route('admin.stacks.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <p class="mt-2 text-sm text-gray-500">Upload an image for the stack (JPEG, PNG, JPG, GIF, SVG, WEBP - Max 5MB)</p>
                    @error('image')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
