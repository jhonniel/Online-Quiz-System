...
<div class="space-y-4 sm:space-y-6 px-2 sm:px-0">
    ...
    <div class="bg-white rounded-2xl shadow-xl border border-gray-200 p-4 sm:p-6">
        <form method="GET" action="{{ url('/admin/tasks/analytics') }}" class="space-y-4">
            ...
            <div class="flex flex-wrap items-center gap-3">
                ...
                <a href="{{ url('/admin/tasks/analytics') }}" class="inline-flex items-center px-4 sm:px-6 py-2 border border-gray-300 text-xs sm:text-sm font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                    Reset
                </a>
            </div>
        </form>
