        ...
        <div class="px-6 py-6">
            ...
            @else
                <div class="text-center py-8">
                    ...
                    <div class="mt-6">
                        <a href="{{ url('/admin/settings') }}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700">
                            Go to Settings
                        </a>
                    </div>
                </div>
    ...
    <div class="bg-white shadow-sm rounded-lg border border-gray-200 overflow-hidden">
        ...
        <div class="px-6 py-6">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <a href="{{ url('/admin/hiring-process/applicants') }}" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                    <div class="flex-shrink-0">
                ...
                <a href="{{ url('/admin/settings') }}" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                    <div class="flex-shrink-0">
                        <svg class="h-8 w-8 text-indigo-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
