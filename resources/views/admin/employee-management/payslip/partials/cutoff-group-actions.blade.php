...
<div class="flex flex-wrap items-center justify-end gap-2 shrink-0">
    <a href="{{ route('admin.payslip.cutoff-summary', $query) }}"
    ...
    @include('admin.employee-management.payslip.partials.group-print-link', [
        'href' => route('admin.payslip.cutoff-summary', array_merge($query, ['print' => 1])),
    ])
    <a href="{{ route('admin.payslip.cutoff-summary.csv', $query) }}"
       onclick="event.stopPropagation()"
