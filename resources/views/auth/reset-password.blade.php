    ...
    <div class="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div class="relative z-10 sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <div class="text-center mb-8">
                <h2 class="text-5xl font-bold bg-gradient-to-r from-gray-900 via-green-600 to-emerald-600 bg-clip-text text-transparent mb-3 animate-fade-in">
                    Reset Password
                </h2>
                <p class="text-xl text-gray-700 mb-2 font-medium animate-slide-up">
                    Enter your new password for <span class="text-primary font-semibold">{{ $settings['system_name'] }}</span>
                </p>
            </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="email" name="email" type="email" autocomplete="username" required autofocus
                                   class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-xl placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 bg-white/50 backdrop-blur-sm"
