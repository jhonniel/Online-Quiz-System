...
<head>
    <meta charset="UTF-8">
    <title>Application Reconsidered - Accepted</title>
</head>
        ...
        <tr>
            <td style="padding: 20px 24px; font-size: 14px; color: #374151; line-height: 1.6;">
                <p style="margin: 0 0 12px 0;">
                    After thorough checking, we consider your application for the
                    <strong>{{ $position->title ?? $application->position_applied }}</strong> position as
                    <strong>accepted</strong>. Please proceed to the next step.
                </p>
