...
(function () {
    ...
    function badgeSvg(size) {
        ...
        return '<span class="verified-badge verified-badge--sm inline-flex items-center flex-shrink-0" title="Verified account" role="img" aria-label="Verified account">'
            + '<svg viewBox="0 0 24 24" width="' + s + '" height="' + s + '" class="twetch-green-check" aria-hidden="true" focusable="false">'
    ...
    window.VerifiedBadgeUI = {
        ...
        nameHtml: function (name, verified, size) {
            ...
            return '<span class="inline-flex items-center gap-1.5 min-w-0 max-w-full align-middle">'
