...
<body>
    <div class="nda-page">
        ...
        <p class="body-text">
            This is to certify that I, <strong>{{ strtoupper($nda->full_name) }}</strong>, of
        ...
        <p class="done-line">
            Done in the City of {{ $nda->city }}, this {{ $nda->agreementDateFormal() }}.
        </p>
        ...
        <div class="signature-block">
            ...
            <div class="signature-identity">
                <p class="signature-meta">{{ strtoupper($nda->full_name) }}</p>
                <p class="signature-meta">{{ strtoupper($branding['company_signature']) }}</p>
            </div>
            <div class="signature-id-group">
                <p class="signature-meta">{{ strtoupper($nda->id_number) }}</p>
                <p class="signature-meta">{{ strtoupper($nda->valid_id_type) }}</p>
            </div>
        </div>
        ...
        <div class="ack-section">
            ...
            @endif
            <p class="ack-meta">{{ $nda->agreementDateUpper() }}</p>
        </div>
    </div>
</body>
</html>
