...
<div class="space-y-6">
    <!-- Page Header -->
    <div class="bg-gradient-to-r from-indigo-500 to-indigo-600 rounded-lg shadow-sm p-4 sm:p-6">
        <div class="flex items-center gap-3 sm:gap-4">
            ...
            <div class="min-w-0">
                <h1 class="text-xl sm:text-2xl font-bold text-white">My Application</h1>
                <p class="text-indigo-100 mt-1 text-sm">View your application status and details</p>
            </div>
        </div>
    </div>
                    ...
                    <div class="px-4 sm:px-6 py-5 sm:py-6">
                        <div class="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
                            ...
                            @if($application->interview_date)
                                <div class="sm:text-right border-t sm:border-t-0 pt-4 sm:pt-0 border-gray-100">
