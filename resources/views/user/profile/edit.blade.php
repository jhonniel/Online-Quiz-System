                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <div>
                            ...
                            <select id="gender"
                                    name="gender"
                                    class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm @error('gender') border-red-300 @enderror">
                                <option value="">Select gender</option>
                                @foreach(\App\Models\User::genderOptions() as $value => $label)
