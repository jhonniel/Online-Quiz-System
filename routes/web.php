...
Route::prefix('admin')->middleware(['auth', 'admin'])->group(function () {
    ...
    Route::middleware(['admin.permission:employee_management'])->group(function () {
        ...
        Route::middleware(['admin.subfeature:employee_management,payslip'])->group(function () {
            ...
            Route::get('/payslip/cutoff-summary', [App\Http\Controllers\Admin\PayslipController::class, 'cutoffSummary'])->name('admin.payslip.cutoff-summary');
            Route::get('/payslip/cutoff-summary/csv', [App\Http\Controllers\Admin\PayslipController::class, 'cutoffSummaryCsv'])->name('admin.payslip.cutoff-summary.csv');
